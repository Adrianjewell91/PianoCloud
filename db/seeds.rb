...
comment21 = Comment.create(body: "Wonderful", user_id: user1.id, parent_id: comment1.id, track_id: track1.id)
comment22 = Comment.create(body: "Love it!", user_id: user2.id, parent_id: comment2.id, track_id: track2.id)
comment23 = Comment.create(body: "Feels so Good!", user_id: user3.id, parent_id: comment3.id, track_id: track3.id)
comment24 = Comment.create(body: "Awesome", user_id: user4.id, parent_id: comment4.id, track_id: track4.id)
comment25 = Comment.create(body: "You're Great!", user_id: user5.id, parent_id: comment5.id, track_id: track5.id)
comment26 = Comment.create(body: "Such exquisite music!", user_id: user1.id, parent_id: comment6.id, track_id: track6.id)
comment27 = Comment.create(body: "Amazing", user_id: user2.id, parent_id: comment7.id, track_id: track7.id)
comment28 = Comment.create(body: "Dazzling", user_id: user3.id, parent_id: comment8.id, track_id: track8.id)
comment29 = Comment.create(body: "Brilliant", user_id: user4.id, parent_id: comment9.id, track_id: track9.id)
comment30 = Comment.create(body: "Hmm, how interesting", user_id: user5.id, parent_id: comment10.id, track_id: track10.id)
comment31 = Comment.create(body: "Thoughtful", user_id: user1.id, parent_id: comment11.id, track_id: track1.id)
comment32= Comment.create(body: "Just great.", user_id: user2.id, parent_id: comment12.id, track_id: track2.id)
comment33 = Comment.create(body: "A good listen", user_id: user3.id, parent_id: comment13.id, track_id: track3.id)
comment34 = Comment.create(body: "Makes me feel so good", user_id: user4.id, parent_id: comment14.id, track_id: track4.id)
comment35 = Comment.create(body: "Happy!", user_id: user5.id, parent_id: comment15.id, track_id: track5.id)
comment36 = Comment.create(body: "Lovely", user_id: user1.id, parent_id: comment16.id, track_id: track6.id)
comment37 = Comment.create(body: "So emotional", user_id: user2.id, parent_id: comment17.id, track_id: track7.id)
comment38 = Comment.create(body: "The world is a beautiful place", user_id: user3.id, parent_id: comment18.id, track_id: track8.id)
comment39 = Comment.create(body: "Let there be light!", user_id: user4.id, parent_id: comment19.id, track_id: track9.id)
comment40 = Comment.create(body: "Very nice.", user_id: user5.id, parent_id: comment20.id, track_id: track10.id)
